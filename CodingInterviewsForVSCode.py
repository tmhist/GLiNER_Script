...
# Specify the local path to your transcripts folder (e.g., "/Users/name/Desktop/folder")
drive_folder_path = "/Users/timurmitrofanov/Desktop/Filip's Task/Transkripte Sammlung/Interviews" 

# List of words or labels that should be ignored during extraction
ignore_list = ["musik", "Musikstil", "lied", "Lieder", "speaker", "A:", "B:", "Danke"]
...
# Definition of entities to find. Labels and column names are synchronized in German
entity_config = [
    {"label": "Musiker", "column_name": "Musiker", "color": "#ff9933", "memo": "name von musikern, komponisten oder saengern."}, # Use HEX code in the https://colorkit.co/color/99ccff/ in order to find the color you need
    {"label": "Musikgenre", "column_name": "Musikgenre", "color": "#ff9999", "memo": "spezifische musikstile oder kategorien like rock, klassik, jazz."},
    {"label": "Einstellung oder Emotion", "column_name": "Einstellung oder Emotion", "color": "#99ff99", "memo": "gefuehle oder meinungen des sprechers."},
    {"label": "Studienfach", "column_name": "Studienfach", "color": "#99ccff", "memo": "fachrichtungen wie physik, soziologie, bwl."},
    {"label": "Akademischer Grad", "column_name": "Akademischer Grad", "color": "#c2c2f0", "memo": "abschluesse wie bachelor, master, promotion."},
    {"label": "Geburtsjahr", "column_name": "Geburtsjahr", "color": "#ffff99", "memo": "angaben zum geburtsjahr."}
]
